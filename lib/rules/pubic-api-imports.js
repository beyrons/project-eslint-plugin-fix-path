...
// создаем константы для идентификации ошибок
            ...
            ImportDeclaration(node) {                                                           // AST :: ImportDeclaration - работаем с нодами импорта
                ...
                if (isImportNotFromPublicApi && !isTestingPublicApi) {
                    context.report({
                        ...
                        fix: (fixer) => {   // fix :: https://eslint.org/docs/latest/developer-guide/working-with-rules#applying-fixes
                            // пишем правило, по которому будем делать автофикс
